...
urlpatterns = [
    ...
    #YOUR LEGIT ENTRY LIST VIEW COMMENTED OUT TO TRY OUT CLASS BASED ALTERNATIVE path('', views.entry_list, name = "list"),
    ...
    #path('<slug:slug>/edit_entry/', views.comment_edit, name='comment_edit'),
